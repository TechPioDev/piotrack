...
class ChatWidgetController extends Controller
{
    ...
    public function update(Request $request, ChatWidget $widget): RedirectResponse
    {
        $data = $request->validate([
            ...
            'settings.knowledge' => 'sometimes|nullable|string|max:5000',
            'settings.ai_disclosure' => 'sometimes|boolean',
            'settings.ai_disclosure_text' => 'sometimes|nullable|string|max:200',
